...
const MovieDetails = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case "want_to_watch": return "badge-secondary";
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-base-content/70 mb-6">
            {movieError || "The movie you're looking for doesn't exist."}
          </p>
            ...
            <div className="flex flex-wrap gap-3">
              <div className="dropdown dropdown-top">
                ...
                <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52 mb-2">
                  <li>
                    <button onClick={() => handleAddToWatchlist("want_to_watch")}>
                      Want to Watch
                    </button>
                  </li>
                  <li>
                    <button onClick={() => handleAddToWatchlist("watching")}>
                      Currently Watching
                    </button>
                  </li>
                  <li>
                    <button onClick={() => handleAddToWatchlist("completed")}>
                      Completed
                    </button>
                  </li>
                </ul>
            ...
            <div className="space-y-4">
              {reviews.map((review) => (
                <div key={review.id} className="border-b border-base-200 pb-4 last:border-b-0">
                  ...
                  {review.comment && (
                    <p className="text-base-content/80 ml-13">
                      {review.comment}
                    </p>
                  )}
                </div>
